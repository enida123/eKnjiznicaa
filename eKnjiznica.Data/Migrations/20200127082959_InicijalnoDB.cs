        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCredits_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true),
                    UserCreditId = table.Column<int>(nullable: false),
                    TransactionTypeId = table.Column<int>(nullable: false),
                    CurrentCredit = table.Column<decimal>(nullable: false),
                    PreviousCredit = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_UserCredits_UserCreditId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserCreditId",
                table: "Transactions",
                column: "UserCreditId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCredits_ApplicationUserId",
                table: "UserCredits",
                column: "ApplicationUserId");
        }
